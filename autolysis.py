...
def generate_narrative(analysis, base_name):
    """Generate a story-like narrative using LLM."""
    headers = {
    ...
    # Storytelling prompt
    prompt = (
        f"Based on the following data analysis, craft a compelling story that explains the insights. "
        f"Make it engaging and accessible, as if narrating to an interested audience. Here is the analysis summary: {analysis}."
    )
